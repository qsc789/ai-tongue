 ...
 */
@RestController
@RequestMapping("constitution/pre")
public class DemoPreConstitutionController {
    private Logger log = LoggerFactory.getLogger(DemoPreConstitutionController.class);
    private final AiTongueProperties aiTongueProperties;
    private final IRestTemplateService restTemplateService;

    @Autowired
    public DemoPreConstitutionController(AiTongueProperties aiTongueProperties, IRestTemplateService restTemplateService) {
    ...
    public String index() throws Exception {
        ...
        String returnUrl = "https://your.domain/constitution/pre/resultReturn"; //您的结果接收地址
...
//        params.add("backImageUrl", "https://your.domaim/tongueBack.jpg");
    ...
    public String taskSimple() throws Exception {
        ...
        ResultVO resultVO = restTemplateService.postForObject(aiTongueProperties.getPreTongueSimpleTaskUrl(), headers, params, ResultVO.class);
